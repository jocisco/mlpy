...
# insert the data
$python ./import_data.py $write_server InterfaceQueues /tmp/data_import_queue.txt  -timestamp '2014-01-01 08:00:00'
$python ./import_data.py $write_server InterfaceQueues /tmp/data_import_queue.txt  -timestamp '2014-01-01 08:15:00'
$python ./import_data.py $write_server InterfaceQueues /tmp/data_import_queue.txt  -timestamp '2014-01-01 08:30:00'
$python ./import_data.py $write_server InterfaceQueues /tmp/data_import_queue.txt  -timestamp '2014-01-01 08:45:00'
$python ./import_data.py $write_server InterfaceQueues /tmp/data_import_queue.txt  -timestamp '2014-01-01 09:00:00'
# explore table
